...
/* Note: the logging levels enum'd below have 5 levels; *
 * 0, 1, 2, 3, 4. However, they are indexed by integers *
 * 1 - 5 when calling the print_err function. This makes *
 * the calling much clearer, and allows the silent flag *
 * to completely silence logging, since it will require *
